...
#include "../bounceball/engine/level.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Level_t, stringdata) + ofs \
...
const QMetaObject Level::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_Level.data,
      qt_meta_data_Level,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Level.stringdata))
        return static_cast<void*>(const_cast< Level*>(this));
    if (!strcmp(_clname, "ScoreBoard"))
        return static_cast< ScoreBoard*>(const_cast< Level*>(this));
